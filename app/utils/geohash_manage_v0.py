...
class geohash_manage:
    ...
    def cover_geohash(self,target_polygon,precision):
        ...
        def loop_check_right_step(geohash,end_geohash,precision):
            ...
            right_step=geohash
            while True:
                right_step=self.geohash_neighbors(right_step,precision,direction="right")
        ...
        def loop_check_up_step(init_candidate,top_candidate,precision):
            ...
            for i in range(len(top_candidate)):
                ...
                while up_step_polygon.intersects(end_polygon)!=True:
                    up_step=self.geohash_neighbors(up_step,precision,direction="top")
        ...
        init_candidate=loop_check_right_step(init_edge_geohash,right_edge_geohash,precision)
        top_candidate=loop_check_right_step(top_edge_geohash,end_edge_geohash,precision)
    ...
    def extract_rect_from_shp(self,shp_file,precision):
        ...
        for i in tqdm(range(len(shp))):
            ...
            for ii,jj in enumerate(polygon_list):
                ...
                single_item["geohash"]=pgh.encode(jj.centroid.y,jj.centroid.x,precision=precision) ### 바뀌었음. 
...
if __name__ == "__main__":
    ...
    glob_list=['/Volumes/WorkSpace/work/ds/geoinfo/geoinfo/src/../data/sgg/LARD_ADM_SECT_SGG_48.shp']
    for i in glob_list:
